export default function ActualCart({eachSingleProduct, cart, setCart}) {
    ...
    const isTrue = cart.some((eachItem) => {
        return eachItem?.element?.id === eachSingleProduct?.id;
    })
    ...
    return (
        <div className="bg-black rounded-md px-3 py-3">
            ...
            <div className="grid grid-cols-3 gap-3">
                ...
                <div className={`text-white my-2 rounded-full ${getColor} px-2 w-16`}>{eachSingleProduct?.rating} ☆</div>
